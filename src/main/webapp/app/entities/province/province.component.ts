...
export class ProvinceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.provinceService
      ...
      .subscribe(
        (res: HttpResponse<IProvince[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProvinces(): void {
    this.eventSubscriber = this.eventManager.subscribe('provinceListModification', () => this.loadPage());
  }
